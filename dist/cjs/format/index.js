...
class Format {
     ...
     */
    static upperCaseToSpace(textOrTexts) {
    ...
    static secondsToHms(d) {
        if (typeof d === "string")
            d = parseInt(d);
        if (isNaN(d))
            return "00:00:00"; // Handle NaN case
     ...
     */
    static simpleTimeFormat(t, includeSeconds = false) {
